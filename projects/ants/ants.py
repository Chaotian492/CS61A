...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        # nend to create a middle-value cur_place
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # by middle-value fire_armor's value to attack bees
        fire_armor = self.armor - amount
        ...
        # execute ant.reduce_armor to update fireant's armor at the end
        # instead of use self.armor-=amount
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        if self.True_Queen:
            ...
            while queen_place.exit:
                if queen_place.exit.ant:
                    # if queen_place.exit.ant.name != "Fire":
                    if not queen_place.exit.ant.Double_damage:
                        queen_place.exit.ant.damage *= 2
                        queen_place.exit.ant.Double_damage = True
                queen_place = queen_place.exit
        else:
            # print(
            #     f"self.name:{self.name} and self.True_Queen:{self.True_Queen},{self.armor}"
            # )
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        queen_armor = self.armor - amount
        if queen_armor <= 0 and self.True_Queen:
            bees_win()
        else:
